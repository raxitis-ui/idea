...
export default class extends BaseSeeder {
  public async run() {
    const filters: { genre: string; label: string; slug: string }[] = [
      ...
      { genre: 'Modello di Business', label: 'SaaS', slug: 'saas' },
      { genre: 'Modello di Business', label: 'Subscription-based', slug: 'subscription' },
      { genre: 'Modello di Business', label: 'Freemium', slug: 'freemium' },
      { genre: 'Modello di Business', label: 'Marketplace', slug: 'marketplace' },
      ...
      // Target di età
      { genre: 'Target di età', label: 'Bambini (0-12)', slug: 'children' },
      { genre: 'Target di età', label: 'Adolescenti (13-17)', slug: 'teenagers' },
      { genre: 'Target di età', label: 'Giovani (18-25)', slug: 'youth' },
      { genre: 'Target di età', label: 'Adulti (26-40)', slug: 'adults' },
      { genre: 'Target di età', label: 'Anziani (41+)', slug: 'seniors' },
      ...
      { genre: 'Livello di innovazione', label: 'Incrementale', slug: 'incremental' },
      { genre: 'Livello di innovazione', label: 'Disruptive', slug: 'disruptive' },
      { genre: 'Livello di innovazione', label: 'Radicale', slug: 'radical' },
